...
script_mod! {
    ...
    mod.widgets.GalleryPopoverPage = set_type_default() do mod.widgets.GalleryPopoverPageBase{
        ...
        scroll_view := ShadScrollYView{
            ...
            popover_preview_section := View{
                width: Fill
                height: Fit
                flow: Down

                popover_preview_panel := mod.widgets.ShadPanel{
                    popover_preview_flip := mod.widgets.GalleryPreviewStackNavigation{
                        width: Fill
                        height: Fit
                        ...
                        code_page +: {
                            body +: {
                                ...
                                GalleryCodeSnippet{
                                    code_view +: { text: #(POPOVER_PREVIEW_CODE) }
                                }
                            }
                        }
                    }
