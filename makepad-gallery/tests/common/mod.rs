...
pub fn open_mobile_command_palette(app: &TestApp) {
...
pub fn open_mobile_sidebar_page(app: &TestApp, sidebar_id: &str, page_title: &str) {
    app.locator(Selector::id("mobile_sidebar_menu_button"))
        .wait_visible()
        .click();
    app.locator(Selector::id(sidebar_id)).wait_visible().click();
